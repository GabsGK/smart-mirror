...
var Conversation = (function() {
  ...
  function displayMessage(newPayload, typeValue) {
    ...
    if (isUser !== null && textExists) {
      ...
      var dataObj = isUser ? newPayload.input : newPayload.output; // si es usuario manda input, si es watson manda output
      ...
      var mirrorMessageElement = document.getElementById(ids.mirrorMessage);
      mirrorMessageElement.innerHTML = messageDiv.innerHTML;
    }
  }
